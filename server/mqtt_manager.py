...
class MQTTManager:
    ...
    def __init__(self, name) -> None:
        ...
        def on_connect(client: mqtt.Client, userdata, flags, rc):
            ...
            topics = [
                (topic + MQTTManager.SUFFIX_SUB, 0) for topic in self.__callbacks.keys()
            ]
    ...
    def subscribe(self, topic, callback: Callable[[Dict[str, Any]], None]):
        ...
        self.__client.subscribe(topic + MQTTManager.SUFFIX_SUB)
    ...
    def publish(self, topic, data: Dict[str, Any]):
        self.__client.publish(topic + MQTTManager.SUFFIX_PUB, json.dumps(data))
