...
gButtons = [Button(gui, text ="V1 OFF",bg='red' ,width=10, height=2,font=("Helvetica", 20),activebackground='red', command = V1ButtonOnClick),
            Button(gui, text ="V1 OFF",bg='red' ,width=10, height=2,font=("Helvetica", 20),activebackground='red', command = V2ButtonOnClick),
            Button(gui, text ="V1 OFF",bg='red' ,width=10, height=2,font=("Helvetica", 20),activebackground='red', command = V3ButtonOnClick),
            Button(gui, text ="V1 OFF",bg='red' ,width=10, height=2,font=("Helvetica", 20),activebackground='red', command = V4ButtonOnClick)]
gButtons[0].place(x=20, y=60)
gButtons[1].place(x=220, y=60)
gButtons[2].place(x=20, y=150)
gButtons[3].place(x=220, y=150)

gDevicesSensors = [Label(gui,height = 6,text = "Device 1", bg='black',fg='white',font=("ariel", 18)),
        ...
        for i in range(len(gButtons)):
                ...
                if Devices[i].bConnected:
                    ...
                    if Devices[i].RelayOut:
                        ...
                        gButtons[i].config(text=buttonText,fg='black',bg='green',activebackground='green')
                    else:
                         buttonText = "OFF"
                         gButtons[i].config(text=buttonText,fg='white',bg='gray',activebackground='gray')
                else:
                    #print("Device " + str(Devices[i].IP) + "  ComError!!!")
                    buttonText = "Com Error"
                    gButtons[i].config(text=buttonText,fg='black',bg='red',activebackground='red')
